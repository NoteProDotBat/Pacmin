...
:: Key up pressed
if %errorlevel%==294 set direction=0 && if !y! GTR 2 (set/a y-=2) ELSE (set y=1)
:: Key down pressed				175
if %errorlevel%==296 set direction=1 && if !y! LSS 175 (set/a y+=2) ELSE (set y=176)
:: Key left pressed
if %errorlevel%==293 set direction=2 && if !x! GTR 0 set/a x-=4
:: Key right pressed
if %errorlevel%==295 set direction=3 && if !x! LSS 308 set/a x+=4
